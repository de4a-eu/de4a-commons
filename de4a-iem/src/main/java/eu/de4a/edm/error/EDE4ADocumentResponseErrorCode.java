...
public enum EDE4ADocumentResponseErrorCode implements IDE4AErrorCode
{
  ...
  EDE4ADocumentResponseErrorCode (@Nonnull @Nonempty final String sID, @Nonnull @Nonempty final String sDisplayName)
  {
    m_sID = sID;
  ...
  @Nullable
  public static EDE4ADocumentResponseErrorCode getFromIDOrNull (@Nullable final String sID)
  {
    return EnumHelper.getFromIDOrNull (EDE4ADocumentResponseErrorCode.class, sID);
  }
}
