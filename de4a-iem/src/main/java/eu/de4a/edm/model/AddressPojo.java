...
import eu.de4a.edm.jaxb.w3.cv.bc.AddressAdminUnitLocationOneType;
import eu.de4a.edm.jaxb.w3.cv.bc.AddressFullAddressType;
import eu.de4a.edm.jaxb.w3.cv.bc.AddressLocatorDesignatorType;
import eu.de4a.edm.jaxb.w3.cv.bc.AddressPostCodeType;
import eu.de4a.edm.jaxb.w3.cv.bc.AddressPostNameType;
import eu.de4a.edm.jaxb.w3.cv.bc.AddressThoroughfareType;
...
public class AddressPojo
{
  ...
  @Nullable
  public eu.de4a.edm.jaxb.cv.cac.AddressType getAsAgentAddress ()
  {
    boolean bAny = false;
    final eu.de4a.edm.jaxb.cv.cac.AddressType aAddress = new eu.de4a.edm.jaxb.cv.cac.AddressType ();
    if (StringHelper.hasText (m_sFullAddress))
    {
  ...
  @Nonnull
  public static Builder builder (@Nullable final eu.de4a.edm.jaxb.w3.locn.AddressType a)
  {
    final Builder ret = new Builder ();
    if (a != null)
    {
