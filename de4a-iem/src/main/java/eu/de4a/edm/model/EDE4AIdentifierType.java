...
public enum EDE4AIdentifierType implements IHasID <String>
{
  ...
  EDE4AIdentifierType (@Nonnull @Nonempty final String sID)
  {
    m_sID = sID;
  }
  ...
  @Nullable
  public static EDE4AIdentifierType getFromIDOrNull (@Nullable final String sID)
  {
    return EnumHelper.getFromIDOrNull (EDE4AIdentifierType.class, sID);
  }
}
