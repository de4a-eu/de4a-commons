 ...
 * @since 2.0.0-rc1
 */
public enum EDE4ALanguageCode implements IHasID <String>, IHasDisplayName
{
  /** Afar */
  AA ("AA", "Afar"),
  /** Afar */
  ...
  EDE4ALanguageCode (@Nonnull @Nonempty final String sID, @Nonnull @Nonempty final String sDisplayName)
  {
    m_sID = sID;
