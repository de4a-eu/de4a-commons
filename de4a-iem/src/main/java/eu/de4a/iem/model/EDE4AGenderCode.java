 ...
 */
public enum EDE4AGenderCode implements IHasID <String>, IHasDisplayName
{
  M ("M", "Male"),
  F ("F", "Female"),
  ...
  EDE4AGenderCode (@Nonnull @Nonempty final String sID, @Nonnull @Nonempty final String sDisplayName)
  {
    m_sID = sID;
