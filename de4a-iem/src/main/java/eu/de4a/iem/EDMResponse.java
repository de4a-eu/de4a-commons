...
import eu.de4a.iem.response.IEDMResponsePayloadProvider;
import eu.de4a.iem.response.ResponseDocumentPojo;
import eu.de4a.iem.response.ResponseDocumentReferencePojo;
import eu.de4a.iem.slot.SlotDataProvider;
...
public class EDMResponse implements IEDMTopLevelObject
{
   ...
   *         {@link eu.de4a.iem.response.IEDMResponsePayloadDocument} or
   *         {@link eu.de4a.iem.response.IEDMResponsePayloadDocumentReference}.
   */
  @Nonnull
  @Nonempty
