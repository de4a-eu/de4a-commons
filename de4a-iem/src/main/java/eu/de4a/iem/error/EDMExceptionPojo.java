...
import eu.de4a.iem.slot.SlotErrorOrigin;
import eu.de4a.iem.slot.SlotTimestamp;

/**
 * Build DE4A EDM exceptions to be used in DE4A error responses.
 *
...
public class EDMExceptionPojo
{
  ...
  private final EDE4AErrorSeverity m_eSeverity;
  ...
  protected EDMExceptionPojo (@Nonnull final EEDMExceptionType eExceptionType,
                              @Nonnull final EDE4AErrorSeverity eSeverity,
  ...
  @Nonnull
  public final EDE4AErrorSeverity getSeverity ()
  {
    return m_eSeverity;
  }
  ...
  public static Builder builder (@Nullable final RegistryExceptionType a)
  {
    ...
    if (a != null)
    {
      ret.exceptionType (a.getClass ())
         .severity (EDE4AErrorSeverity.getFromIDOrNull (a.getSeverity ()))
  ...
  public static class Builder
  {
    ...
    private EDE4AErrorSeverity m_eSeverity;
    ...
    {
      return severity (EDE4AErrorSeverity.FAILURE);
    }

    @Nonnull
    public Builder severity (@Nullable final EDE4AErrorSeverity e)
    {
      m_eSeverity = e;
      return this;
    }
    ...
    @Nonnull
    public Builder errorOrigin (@Nullable final EDE4AErrorOrigin e)
    {
