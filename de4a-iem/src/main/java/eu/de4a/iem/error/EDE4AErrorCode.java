 ...
 */
public enum EDE4AErrorCode implements IDE4AErrorCode
{
  /** Uncategorized error */
  GEN ("GEN"),
  ...
  EDE4AErrorCode (@Nonnull @Nonempty final String sID)
  {
    m_sID = sID;
  }
  ...
  @Nullable
  public static EDE4AErrorCode getFromIDOrNull (@Nullable final String sID)
  {
    return EnumHelper.getFromIDOrNull (EDE4AErrorCode.class, sID);
  }
}
