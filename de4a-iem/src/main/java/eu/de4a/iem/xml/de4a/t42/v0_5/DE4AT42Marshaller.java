...
import eu.de4a.iem.jaxb.t42.v0_5.LegalEntityType;

/**
 * Special marshaller for DE4A T4.2 v0.5 pilot. This class can ONLY ready T4.2
...
public class DE4AT42Marshaller <JAXBTYPE> extends GenericJAXBMarshaller <JAXBTYPE>
{
  ...
  {
    return new DE4AT42Marshaller <> (LegalEntityType.class, new eu.de4a.iem.jaxb.t42.v0_5.ObjectFactory ()::createLegalEntity);
  }
}
