...
import eu.de4a.iem.model.EDE4ALanguageCode;
import eu.de4a.iem.model.EDE4AQueryDefinitionType;
import eu.de4a.iem.model.EDE4AResponseOptionType;
import eu.de4a.iem.model.PersonPojo;
import eu.de4a.iem.request.EDMRequestPayloadDocumentID;
import eu.de4a.iem.request.IEDMRequestPayloadProvider;
import eu.de4a.iem.slot.SlotAuthorizedRepresentative;
import eu.de4a.iem.slot.SlotConsentToken;
import eu.de4a.iem.slot.SlotDataConsumer;
import eu.de4a.iem.slot.SlotDataSubjectLegalPerson;
import eu.de4a.iem.slot.SlotDataSubjectNaturalPerson;
import eu.de4a.iem.slot.SlotDatasetIdentifier;
import eu.de4a.iem.slot.SlotIssueDateTime;
import eu.de4a.iem.slot.SlotProcedure;
import eu.de4a.iem.slot.SlotSpecificationIdentifier;
import eu.de4a.iem.xml.IJAXBVersatileReader;
import eu.de4a.iem.xml.IVersatileWriter;
import eu.de4a.iem.xml.JAXBVersatileReader;
import eu.de4a.iem.xml.JAXBVersatileWriter;
...
public class EDMRequest implements IEDMTopLevelObject
{
   ...
   *         of {@link eu.de4a.iem.request.IEDMRequestPayloadDocumentID}.
   */
  @Nonnull
