...
public final class DE4AT41MarshallerTest
{
  ...
  private static final String BASE_PATH = "src/test/resources/de4a/t4.1/uc1/v2021-02-11/";
  ...
  public void testHigherEducationEvidence ()
  {
    ...
    _testReadWrite (DE4AT41Marshaller.higherEducationEvidence (), new File (BASE_PATH + "SA-UC1-15-02-2021-JSI.xml"));
  }
}
