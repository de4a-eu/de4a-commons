...
import eu.de4a.edm.jaxb.cccev.CCCEVDocumentReferenceType;
...
import eu.de4a.edm.jaxb.dcterms.DCPeriodOfTimeType;
...
public class DatasetPojo
{
  ...
  public static class Builder
  {
    ...
    @Nonnull
    public Builder language (@Nullable final EDE4ALanguageCode e)
    {
