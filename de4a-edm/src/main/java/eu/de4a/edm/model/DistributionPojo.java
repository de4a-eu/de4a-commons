...
import eu.de4a.edm.jaxb.dcterms.DCMediaType;
...
{
  private final EDE4ADistributionFormat m_eFormat;
  private final String m_sMediaType;

  public DistributionPojo (@Nullable final EDE4ADistributionFormat eFormat, @Nullable final String sMediaType)
  {
    m_eFormat = eFormat;
  ...
  @Nullable
  public final EDE4ADistributionFormat getFormat ()
  {
    return m_eFormat;
  }
  ...
  public static Builder builder (@Nullable final DCatAPDistributionType a)
  {
    ...
    {
      if (a.getFormat () != null)
        ret.format (EDE4ADistributionFormat.getFromIDOrNull (TypeConverter.convert (a.getFormat ().getContentAtIndex (0), String.class)));
  ...
  {
    private EDE4ADistributionFormat m_eFormat;
    ...
    @Nonnull
    public Builder format (@Nullable final EDE4ADistributionFormat e)
    {
      m_eFormat = e;
      return this;
    }
