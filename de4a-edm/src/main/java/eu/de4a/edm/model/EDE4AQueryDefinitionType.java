...
public enum EDE4AQueryDefinitionType implements IHasID <String>
{
  ...
  EDE4AQueryDefinitionType (@Nonnull @Nonempty final String sID)
  {
    m_sID = sID;
  }
  ...
  @Nullable
  public static EDE4AQueryDefinitionType getFromIDOrNull (@Nullable final String sID)
  {
    return EnumHelper.getFromIDOrNull (EDE4AQueryDefinitionType.class, sID);
  }
}
