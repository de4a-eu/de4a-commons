...
/**
 * Test class for class {@link EDE4AConcept}.
 *
...
public final class EToopConceptTest
{
  ...
  {
    for (final EDE4AConcept e : EDE4AConcept.values ())
    {
      assertTrue (StringHelper.hasText (e.getID ()));
      assertSame (e, EDE4AConcept.getFromIDOrNull (e.getID ()));
    }
  }
  ...
  public void testOldNames ()
  {
    ...
    for (final String s : RegExHelper.getSplitToArray (sOldNames, "\r\n"))
      if (StringHelper.hasText (s))
        assertNotNull (EDE4AConcept.getFromIDOrNull (s));
  }
}
